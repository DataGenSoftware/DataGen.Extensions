...
namespace DataGen.Extensions.Publish.Common
{
    ...
    {
        public ProductsManager ProductManager { get; set; }

        public PublishManager PublishManager { get; set; }

        public VersionManager(ProductsManager productManager)
        {
        ...
        {
            string fileContent;
            var fileName = "..\\..\\..\\" + this.ProductManager.ProductName + "\\Properties\\AssemblyInfo.cs";
        ...
        {
            Console.WriteLine();
            Console.WriteLine(string.Format("---{0} Change version menu---", this.ProductManager.ProductName));
        ...
        {
            string fileName = "..\\..\\..\\" + this.ProductManager.ProductName + "\\Properties\\AssemblyInfo.cs";
            string regexPattern = "\\[assembly: AssemblyVersion\\(\\\"\\d+\\.\\d+\\.\\d+.\\*\\\"\\)\\]";
        ...
        {
            string fileName = "..\\..\\..\\NuGet\\" + this.ProductManager.ProductName + ".nuspec";
        ...
        private void UpdateDependenciesVersion()
        {
            ...
            foreach (var product in this.ProductManager.Products)
            {
        ...
        private void UpdateDependencyVersion(string dependentProduct)
        {
            ...
            string regexPattern = "<dependency id=\"" + this.ProductManager.ProductName + "\" version=\"\\d+\\.\\d+\\.\\d+\" />";
            string placeholder = "<dependency id=\"" + this.ProductManager.ProductName + "\" version=\"{0}\" />";
        ...
        private void CommitCurrentVersion()
        {
            ...
            this.PublishManager.Git("add ..\\..\\..\\" + this.ProductManager.ProductName + "\\Properties\\AssemblyInfo.cs");
            this.PublishManager.Git("add ..\\..\\..\\NuGet\\" + this.ProductManager.ProductName + ".nuspec");
